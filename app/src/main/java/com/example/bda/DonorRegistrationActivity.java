...
public class DonorRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerFullName = (TextInputEditText) findViewById(R.id.registerFullName);
        registerIdNumber =(TextInputEditText) findViewById(R.id.registerIdNumber);
        registerPhoneNumber =(TextInputEditText) findViewById(R.id.registerPhoneNumber);
        ...
        // FireBase Auth Method Is Used For Authentication Process;
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if(task.isSuccessful()){
                                                                    Toast.makeText(DonorRegistrationActivity.this, "Image Url Added To Data Base", Toast.LENGTH_SHORT).show();
                                                                } else {
                                                                    Toast.makeText(DonorRegistrationActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
